...
public class KeyInput extends KeyAdapter{
    ...
    public KeyInput(Handler handler,GamePertama game){
    ...
    public void keyPressed(KeyEvent e){
        ...
        for(int i = 0; i<handler.object.size(); i++){
            ...
            if(tempObject.getId() == ID.Player){
                ...
                if(key == KeyEvent.VK_W&&key == KeyEvent.VK_S){ tempObject.setVelY(0);keyDown[0] = true;
                    keyDown[2] = true;}
                if(key == KeyEvent.VK_A&&key == KeyEvent.VK_D){ tempObject.setVelX(0);keyDown[1] = true;
                    keyDown[3] = true;}
        ...
        if(key == KeyEvent.VK_P&&game.gameState==STATE.Game){
            if(GamePertama.paused)GamePertama.paused = false;
            else GamePertama.paused = true;
        }
